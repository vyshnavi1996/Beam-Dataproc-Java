...
// created a class name MinimalPageRankMachha
public class MinimalPageRankMachha {
  public static void main(String[] args) {
   ...
   PCollection<KV<String,String>> p1 = MachhaMapper01(p,"go.md",dataFolder);
   PCollection<KV<String,String>> p2 = MachhaMapper01(p,"python.md",dataFolder);
   PCollection<KV<String,String>> p3 = MachhaMapper01(p,"java.md",dataFolder);
   PCollection<KV<String,String>> p4 = MachhaMapper01(p,"README.md",dataFolder);
   //merged all the key value pairs in to the PCollectionList and then in to the Pcollection
    ...
    // generating the output with the file name machhacounts
    pLinksString.apply(TextIO.write().to("machhacounts"));  
    p.run().waitUntilFinish();
  }
 public static PCollection<KV<String,String>> MachhaMapper01(Pipeline p, String filename, String dataFolder){
